...
4. Select-Gameobject->3D Object → Cube → Rename to Agent
...
13. Add the Decision requestor
 Addcomponent->ML Agents -> Decision Requestor ->set decision period 5 
14. In command prompt, Run the command to start ML agents to learn the Unity 
...
15. In unity start play button and see the output of roller ball
16.Run tensor board in command prompt
tensorboard --logdir results
17. Get the results by running the localhost on specific port ( shown in tensorboard)
...
### Output:
#### Before Training :
<img width="519" height="320" alt="WhatsApp Image 2026-05-22 at 08 09 44" src="https://github.com/user-attachments/assets/0483e233-9c38-47cf-a25a-4e83d18a5e36" />

#### After Training :
<img width="421" height="292" alt="WhatsApp Image 2026-05-22 at 08 09 45" src="https://github.com/user-attachments/assets/4acae5e2-6b6a-4e03-8025-d5c9c9f788df" />
